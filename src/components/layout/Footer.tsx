...
export function Footer() {
  ...
  const links = {
    product: [
      ...
      { name: 'Create Organization', href: '/create-organization' },
    ...
    resources: [
      ...
      { name: 'Discord', href: 'https://discord.com', target: '_blank' },
    ],
    legal: [
          ...
          <div>
            ...
            {chain && (
              <div className="flex items-center space-x-2">
                <div className={`w-2 h-2 rounded-full ${chain.id === 4202 ? 'bg-green-500' : 'bg-amber-500'} animate-pulse`} />
