/**
 * Analytics Page
 * Route: /contract-dashboard/analytics
 */
...
import AnalyticsDashboard from '@/components/contract/AnalyticsDashboard';
...
export default function AnalyticsPage() {
  ...
  return (
    <div className="min-h-screen py-8 mobile-px">
      <AnalyticsDashboard proxyAddress={organizationProxy} />
    </div>
  );
}
